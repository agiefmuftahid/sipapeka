    ...
    <section class="content">
      ...
      <div class="row" style="font-family: 'Bree Serif', serif;">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-aqua"><div class="icon"><i class="ion ion-ios-cart-outline"></i></div></span>

            <div class="info-box-content">
              <span class="info-box-text">Jumlah Pembelian</span>
              <span class="info-box-number"><?php echo $jumlahBeli;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jumlahStok;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Distribusi Barang</span>
              <span class="info-box-number"><?php echo $jumlahDistribusi;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <!-- /.row --><br>
      <div class="row" style="font-family: 'Bree Serif', serif;">
        <div id="container2" style="height: 400px; margin: auto" class="col-md-8"></div>
        <div class="box box-default col-md-4" style="width: 30%">
          <div class="box-header with-border">
              <center><label>Tabel Jumlah Distribusi per Bulan</label></center>
            </div>
          <div class="box-body">

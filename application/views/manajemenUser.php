          ...
          <div class="nav-tabs-custom">
            <div class="tab-content">
              <div class="active tab-pane" id="activity1">
                  <h2 class="box-title" style="font-family: 'Bree Serif', serif;">Data User&nbsp;
                  <a data-balloon="Menampilkan semua data user dari sistem" data-balloon-pos="right" class="text-black"><small><i class="fa fa-question-circle"></i></small></a>&nbsp;</h2>
                  <br>
                  <div>
                        ...
                        <td>
                            <center>
                              <div class="tooltip-demo">
                                ...
                                <?php if($dt['username'] == 'admin'){$teks = 'disabled';}else{$teks='';}?>
                                <a><button <?php echo $teks ?> data-balloon="Hapus Data" data-balloon-pos="up" class="btn btn-danger" data-toggle="modal" data-target="#hapus-data<?php echo $x; ?>" title="Hapus Data"><i class="fa fa-trash"></i></button></a>
                              </div>
                            </center>
                        </td>
                      </tr>
          ...
          <div class="modal fade" id="tambah-data" role="dialog">
            <div class="modal-dialog" style="width:60%;">
              <div class="modal-content">
                ...
                <form action="<?php echo base_url('User/tambahUser')?>" method="post" id="form" class="form-horizontal">
                  <div class="modal-body form">
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input name="password" id="password" required placeholder="Password" class="form-control" type="text">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <select name="pegawai" required id="pegawai" class="form-control" style="width: 100%;">
                              <option selected hidden value="0">-- Pilih Pegawai--</option>
                              <?php $pegawai = $this->db->query('select * from tb_pegawai')->result_array(); ?>
                              <?php foreach ($pegawai as $na) {?>
                              <option value="<?php echo $na['NIP_pegawai'];?>"><?php echo $na['namaPegawai'];?></option>
                              <?php } ?>
                            </select>
                          </div>
                        </div>
...
<!-- End Modal Tambah -->
<!-- Dialog Box -->
<?php $user1 = $this->db->query('select * from tb_user join tb_pegawai on tb_user.NIP_pegawai=tb_pegawai.NIP_pegawai')->result_array();
$y=1; foreach ($user1 as $dt){?>
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="hapus-data<?php echo $y; ?>" class="modal fade">
    <div class="modal-dialog" style="width:30%;margin-top: 150px;">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('User/hapusUser/'.$dt['username']);?>" method="post" enctype="multipart/form-data" role="form">
        <div class="modal-body">
          <p>Anda Yakin Ingin Menghapus Data ? </p>
        </div>
        <div class="modal-footer">
            <a href="<?php echo base_url('User/hapusUser/'.$dt['username']);?>" class="btn btn-danger"> Ya&nbsp;</a>
...
<!-- dialog box -->
  ...
  $user = $this->db->query('select * from tb_user join tb_pegawai on tb_user.NIP_pegawai=tb_pegawai.NIP_pegawai')->result_array(); $g=1;
foreach($user as $dt){?>
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="ubah-data<?php echo $g;?>" class="modal fade">
      <div class="modal-dialog" style="width:40%;margin-top: 100px;margin-left: 400px">
        <div class="modal-content">
          ...
          <div class="modal-body">
          <?php if($dt['username'] == 'admin'){$teks = 'readonly';}else{$teks='';}?>
            <div class="form-group">
              <label class="control-label col-md-2">Username</label>
              <div class="col-md-10">
                <input name="username" <?php echo $teks ?> id="username" value="<?php echo $dt['username'] ?>" max="12" required class="form-control" type="text">
            ...
            <input type="hidden" name="form" value="User/formUser">
            <div class="form-group">

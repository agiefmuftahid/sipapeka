...
<head>
  ...
  <title>Cetak | Distribusi Barang <?php $tgl = date("Y-m-d h:i:sa");echo $tgl;?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <table class="table table-bordered" style="width:100%;border-width: 2px;border-color: #000000">
    <tbody>
    <tr>
      <td><section class="content">
      <!-- title row -->
      <?php
      ...
      <div class="row">
        ...
        <div class="pull-right">
          <p>T.A&nbsp;: <?php echo $data2[0]['tahun']; ?>
          <p>Nomor Bukti&nbsp;: <?php echo $data2[0]['noBukti']; ?>
          </div><br><br><br><br><br>
        <center>
          <h4>KUITANSI/BUKTI PEMBAYARAN</h4><br>
        </center>
        <p>Bukti pengambilan barang yang di rincikan sebagai berikut :
          <table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
            ...
            <tbody>
              <tr>
                ...
                <td><?php $hu = $dt['hargaSatuan']*$dt['jumlahKeluar'];echo 'Rp. ' . number_format( $hu, 0 , '' , '.' ) . ',-'?></td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
      ...
      <h5 style="text-align: right;">Total : <?php $x=0; $tot=0; foreach ($data as $dt){  $tot += $data2[$x]['jumlahTotal']; $x++;} echo 'Rp. ' . number_format( $tot, 0 , '' , '.' ) . ',-'; ?></h5>
      <br>
      <br>
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col" align="center">
          <address>
            ...
            <strong>Pengelola Barang</strong><br>
            <br>
            <br>
            <br>
            <br>
            <?php $where = $data2[0]['NIP_user'];$nama = $this->db->query('select namaPegawai as nama,NIP_pegawai from tb_pegawai where NIP_pegawai='.$where)->row();$user = $this->db->query('select namaPegawai as nama,tb_user.NIP_pegawai from tb_pegawai join tb_user on tb_pegawai.NIP_Pegawai=tb_user.NIP_pegawai where tb_user.NIP_pegawai='.$where)->row();
             echo $user->nama; ?><br>
             NIP. <?php echo $user->NIP_pegawai;?>
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
        ...
        <div class="col-sm-4 invoice-col" align="center">
          <address>
            ...
            <br>
            <br>
            <?php echo $data2[0]['namaPegawai']; ?><br>
            NIP. <?php echo $data2[0]['NIP'] ?>
          </address>
        </div>
        <!-- /.col -->
      </div>

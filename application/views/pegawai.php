...
<head>
  ...
  <title>Manajemen Pegawai | Badan Pertanahan Nasional Kanwil Provinsi Bengkulu</title>
          ...
          <div class="nav-tabs-custom">
            <div class="tab-content">
              <div class="active tab-pane" id="activity5">
                  <h2 class="box-title" style="font-family: 'Bree Serif', serif;">Tabel Data Pegawai&nbsp;
                  <a data-balloon="Menampilkan data pegawai BPN dalam bentuk tabel" data-balloon-pos="right" class="text-black"><small><i class="fa fa-question-circle"></i></small></a>&nbsp;</h2><br>
                  <div>
                  ...
                  <form action="<?php echo base_url('Pegawai/formPegawai') ?>" method="post">
                    <div style="margin-left: 270px;">
                      <div class="col-md-3">
                        <select name="field" id="field" class="form-control" style="width: 100%;" >
                          <option selected="selected" disabled="disabled" value="">Filter By</option>
                          <option value="namaPegawai">Nama</option>
                          <option value="NIP_pegawai">NIP</option>
          ...
          <div class="modal fade" id="tambah-data" role="dialog">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo base_url('Pegawai/tambahPegawai')?>" method="post" id="form" class="form-horizontal">
                  <div class="modal-body form">
                      <div class="form-body">
                        <div class="form-group">
                          <label class="control-label col-md-3">NIP</label>
                          <div class="col-md-9">
                            <input name="NIP_pegawai" id="NIP_pegawai" required placeholder="NIP" class="form-control" type="text" pattern="\d*" maxlength="18" minlength="18">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <select name="idBidang" required id="idBidang" class="form-control" style="width: 100%;">
                              <option selected hidden value="0">-- Pilih --</option>
                              <?php foreach ($bidang as $n) {?>
                              <option value="<?php echo $n['idBidang'];?>"><?php echo $n['namaBidang'];?></option>
                              <?php } ?>
                            </select>
                          </div>
                        </div>
...
<!-- End Modal Tambah -->
<!-- Modal Ubah -->
<?php $w=1; foreach ($data as $dt) {?>
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data<?php echo $w;?>" class="modal fade" style="font-family: 'Bree Serif', serif;">
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
              ...
              <form class="form-horizontal" action="<?php echo base_url('Pegawai/ubahPegawai')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                      <div class="form-group">
                          <label class="control-label col-md-3">NIP</label>
                          <div class="col-md-9">
                            <input name="NIP_lama" id="NIP_lama" value="<?php echo $dt['NIP_pegawai'] ?>" required placeholder="NIP" class="form-control" type="hidden">
                            <input name="NIP_pegawai" id="NIP_pegawai" value="<?php echo $dt['NIP_pegawai'] ?>" required placeholder="NIP" class="form-control" type="text">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-3">Nama Pegawai</label>
                          <div class="col-md-9">
                            <input name="namaPegawai" id="namaPegawai" value="<?php echo $dt['namaPegawai'] ?>" required placeholder="Nama Pegawai" class="form-control" type="text">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-3">Bidang</label>
                          <div class="col-md-9">
                            <select name="idBidang" required id="idBidang" class="form-control" style="width: 100%;">
                              <option selected hidden value="<?php echo $dt['idBidang'];?>"><?php echo $dt['namaBidang'];?></option>
                              <?php foreach ($bidang as $n) {?>
                              <option value="<?php echo $n['idBidang'];?>"><?php echo $n['namaBidang'];?></option>
                              <?php } ?>
                            </select>
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="hapus-data<?php echo $y; ?>" class="modal fade">
    <div class="modal-dialog" style="width:30%;margin-top: 150px;">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="<?php echo base_url('Pegawai/hapusPegawai/'.$dt['NIP_pegawai']);?>" class="btn btn-danger"> Ya&nbsp;</a>
      ...
      <div class="modal-dialog" style="width:40%;margin-top: 100px;margin-left: 400px">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="form" value="Pegawai/formPegawai">
            <div class="form-group">
...
<script>
      $(document).ready(function() {
          ...
          $('#edit-data').on('show.bs.modal', function (event) {
              ...
              modal.find('#NIP_lama').attr("value",div.data('nippegawai'));
              modal.find('#namaPegawai').attr("value",div.data('namapegawai'));
              modal.find('#idBidang').attr("value",div.data('idbidang'));

   ...
   <hr style="border-style:solid;border-color:black;border-width:8;">
      <div class="row">
        <div class="col-xs-12">
          ...
          <center><h3 class="box-title">Rencana Anggaran Belanja<br><small>Tahun Anggaran&nbsp;:&nbsp;<?php if(!empty($data[0]['tahun'])){echo $data[0]['tahun'];}?></h3></center><br>
          <div class="pull-left"><small>
          <p>PERIHAL&nbsp;: ANGGARAN BARANG PERSEDIAAN KANTOR
          ...
          <p>KODE UAKPB&nbsp;: 056012600432442000KD</p></small>
                  ...
                  <table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
                    <thead>
                      ...
                      <tr>
                        <td colspan="9" class="text-red"><?php echo $dt['kategori']?></td>
                      </tr>
                      <?php $where = $this->db->query('select *,tb_beli.jumlah as jlh from tb_beli join tb_barang on tb_beli.kodeBarang=tb_barang.kodeBarang join tb_kategori on tb_barang.idKategori=tb_kategori.idKategori where tb_barang.idKategori ="'.$dt['idKategori'].'"')->result_array();
                      foreach($where as $d){?>
                      <tr>
                        <td><?php echo ++$no;?></td>
      ...
      <div class="row invoice-info">
        ...
        <br> 
          <address>
            Bengkulu, <?php echo tgl_indo(date('Y-m-d')); ?><br>
            <strong>Perencana</strong><br>
            <br> 
            <br> 
            <br> 
            <br>Anis Wulansari, S.SiT
            <br>NIP. 197811271997032001
          </address>
        </div>
        <!-- /.col -->
      </div>

          ...
          <div class="nav-tabs-custom">
            <div class="tab-content">
              <div class="active tab-pane" id="activity1">
                  ...
                  <a data-balloon="Menampilkan data pembelian barang habis pakai dalam bentuk tabel" data-balloon-pos="right" class="text-black"><small><i class="fa fa-question-circle"></i></small></a>&nbsp;</h2><br>
                  <div>
                  ...
                  <form action="<?php echo base_url('Admin/formBeli') ?>" method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td><?php echo $dt['kdBarang'];?></td>
                        <td><?php echo $dt['namaBarang'];?></td>
                        <td><?php echo $dt['kategori'];?></td>
                        <td><?php echo $dt['jumlah'];?></td>
                        <td><?php $he = $dt['jumlah'] * $dt['hargaSatuan'];echo 'Rp. ' . number_format( $he, 0 , '' , '.' ) . ',-'?></td>
                        <td>
                            <center>
                              <div class="tooltip-demo">
                                <a>
          ...
          <div class="modal fade" id="tambah-data" role="dialog">
            <div class="modal-dialog" style="width:60%;">
              <div class="modal-content">
                ...
                <form action="<?php echo base_url('Admin/tambahBeli')?>" method="post" id="form" class="form-horizontal">
                      ...
                      <div class="form-body">
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            ...
                            <input type="text" required name="tanggalBeli" class="form-control pull-right" id="date">
                            </div>
                          </div>
                          <?php $id=$this->db->query("Select COUNT(noBukti)+1 as idMax from tb_beli");?>
                          <label class="control-label col-md-2">No. Bukti</label>
                          <div class="col-md-3">
                            <input name="noBukti" readonly id="noBukti" value="<?php echo $id->row()->idMax.'/'.date('m').'/'.date('Y');?>" required placeholder="No. Bukti" class="form-control" type="text">
                          </div>
                        </div>
                        <table class="table">
                          <tbody>
                            <tr>
                                <td colspan="3" style="text-align: center;">Nama Barang :</td>
                                <td colspan="3" style="text-align: center;">Kategori :</td>
                            </tr>
                            <tr>
                              <td colspan="3">
                                <select name="kodeBarang" required id="kodeBarang" class="form-control" style="width: 100%;">
                                  ...
                                  <option value="1">Tambah Baru</option>
                            ...
                            <tr>
                              <td colspan="3"><input name="namaBarang" disabled id="namaBarang" required placeholder="Nama Barang" class="form-control" type="text"></td>
                              <td colspan="3"><input name="ktg" disabled id="ktg" required placeholder="Kategori" class="form-control" type="text"></td>
                            </tr>
                            <tr>
                              <td colspan="2" style="text-align: center;">Kode Barang :</td>
                              <td colspan="2" style="text-align: center;">Harga Satuan :</td>
                              <td colspan="2" style="text-align: center;">Satuan :</td>
                            </tr>
                            <tr>
                              <td colspan="2"><input name="kdBarang" disabled id="kdBarang" required placeholder="Kode Barang" class="form-control" type="text"></td>
                              <td colspan="2"><input name="hargaSatuan" disabled id="hargaSatuan" required placeholder="Harga" class="form-control" type="text"></td>
                              <td colspan="2"><input name="satuan" disabled id="satuan" required placeholder="Satuan" class="form-control" type="text"></td>
                            </tr>
                            <tr>
                              <td></td>
                              <td></td>
                            ...
                            <tr>
                              ...
                              <td ><input name="jumlah" id="jumlah" required placeholder="Jumlah" class="form-control" type="text"></td>
                            </tr>
                          </tbody>
                        </table>
                    </div>
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data<?php echo $y;?>" class="modal fade">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <form class="form-horizontal" action="<?php echo base_url('Admin/ubahBeli')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          ...
                          <input type="text" required value="<?php echo $dt['tanggalBeli'];?>" name="tanggalBeli" class="form-control pull-right" id="tanggalBeli">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input name="jumlah" id="jumlah" value="<?php echo $dt['jumlah'];?>" required placeholder="Jumlah" class="form-control" type="text">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input name="hargaSatuan" value="<?php echo $dt['hargaSatuan'];?>" id="hargaSatuan" required placeholder="Harga per Satuan" class="form-control" type="text">
                        </div>
                      </div>
                    </div>
                    <div class="modal-footer">
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="hapus-data<?php echo $y; ?>" class="modal fade">
    <div class="modal-dialog" style="width:30%;margin-top: 150px;">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('Admin/hapusBeli/'.$dt['noBukti']);?>" method="post" enctype="multipart/form-data" role="form">
        <div class="modal-body">
          <p>Anda Yakin Ingin Menghapus Data ? </p>
        </div>
        <div class="modal-footer">
            <a href="<?php echo base_url('Admin/hapusBeli/'.$dt['noBukti']);?>" class="btn btn-danger"> Ya&nbsp;</a>
...
<script type="text/javascript">
  function he(){
    ...
    $.ajax({
      url : "<?php echo site_url('Admin/he/')?>/" + id,
      type: "GET",
      dataType: "JSON",
  ...
  $(document).ready(function(){
    $('#kodeBarang').change(function(){
      ...
      }else
      {
        ...
        $.ajax({
          url : "<?php echo site_url('Admin/ajax_edit3/')?>",
          type: "GET",
          data : {'fak':fak},
          dataType: "JSON",
          success: function(data)

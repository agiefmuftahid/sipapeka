   ...
   <hr style="border-style:solid;border-color:black;border-width:8;">
      <div class="row">
        <div class="col-xs-12">
          ...
          <center><h3 class="box-title">Laporan Stok Barang</h3></center><br>
          ...
          <p>KODE UAKPB&nbsp;: 056012600432442000KD</p></small>
                  ...
                  <table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
                    <thead>
                      ...
                      <?php $where = $this->db->query('select *,tb_beli.jumlah as jlh from tb_barang join tb_beli on tb_barang.kodeBarang=tb_beli.kdBarang join tb_kategori on tb_barang.idKategori=tb_kategori.idKategori where tb_barang.idKategori ="'.$dt->idKategori.'"')->result();
                      foreach($where as $d){?>
                      <tr>
                        <td><?php echo ++$no;?></td>

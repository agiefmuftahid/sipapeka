          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity3">
                <div class="box-body">
                    <div class="col-md-12">
                      <center><h3 class="box-title" style="font-family: 'Bree Serif', serif;">Tambah Data Distribusi</h3>
                  <?=$this->session->flashdata('notif')?></center></br></br>
                      <form class="form-horizontal" id="form_transaksi" role="form">
                            <div class="col-md-9">
                              <div class="form-group">
                              <?php $id=$this->db->query("SELECT IF(noBukti is not null,MAX(CAST(SUBSTRING(noBukti, 1, length(noBukti)-8)as int))+1,'1') as idMax FROM tb_distribusi ORDER BY noBukti ASC");?>
                                <label class="control-label col-md-3" 
                                  for="nama_barang">No Bukti :</label>
                                <div class="col-md-2">
                                  <input type="text" class="form-control reset" 
                                    name="noBukti1" value="<?php echo $id->row()->idMax ?>" readonly id="bukti1">
                                </div>
                                <div class="col-md-3">
                                  <select name="noBukti2" required id="bukti2" class="form-control" style="width: 100%;">
                                    <option selected hidden value="-">-- Pilih --</option>
                                    <?php foreach ($bidang as $dt) {?>
                                    <option value="<?php echo $dt['idBidang'];?>"><?php echo $dt['namaBidang']?></option>
                                    <?php } ?>
                                  </select>
                                </div>
                                <div class="col-md-2">
                                  <input type="text" class="form-control reset" 
                                    name="noBukti3" value="<?php echo date('m');?>" readonly id="bukti3">
                                </div>
                                <div class="col-md-2">
                                  <input type="text" value="<?php echo date('Y');?>" readonly class="form-control reset" 
                                    name="noBukti4" id="bukti4">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3" 
                              ...
                              <?php $admin = $this->db->query('select * from tb_user join tb_pegawai on tb_user.NIP_pegawai=tb_pegawai.NIP_pegawai where tb_user.NIP_pegawai="'.$nip.'"')->result_array(); foreach($admin as $adm){?>
                              <div class="form-group">
                                <label class="control-label col-md-3" 
                                  for="nama_barang">Admin</label>
                                <div class="col-md-9">
                                  <input type="text" class="form-control reset" 
                                    name="admin" value="<?php echo $adm['namaPegawai'] ?>" readonly id="admin">
                                </div>
                              </div>
                              <?php } ?>
                              <div class="form-group">
                      ...
                      <form action="<?php echo base_url('Kwitansi/tambahDistribusi');?>" role="form" method="post" class="form-horizontal">
              ...
              <div class="tab-pane" id="timeline3">
                <div class="box-body">
                  ...
                  <form action="<?php echo base_url('Kwitansi/formDistribusi') ?>" method="post">
                            ...
                            <tr>
                              ...
                              <td>
                                <select name="field" id="field" class="form-control" style="width: 100%;" >
                                  ...
                                  <option value="namaBidang">Bidang</option>
                                  <option value="tglDistribusi">Tahun Anggaran</option>
                                </select>
                              </td>
                              <td>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php $x=1;   $no=0; foreach($data as $dt){?>
                            <tr>
                                      ...
                                      <td><?php $barang=$this->db->query('select tb_barang.namaBarang, tb_barang.kodeBarang from tb_barang INNER JOIN tb_kwitansi ON tb_barang.kodeBarang = tb_kwitansi.kodeBarang WHERE tb_kwitansi.noBukti="'.$dt['noBukti'].'"')->result_array();
                                        foreach ($barang as $barang){?>
                                        <?php echo "- ".$barang['namaBarang']." <br>"; ?>
                                        </a>
                                         <?php }?>
                                      </td>
                                      <td><?php $barang=$this->db->query('select tb_kwitansi.jumlah from tb_barang INNER JOIN tb_kwitansi ON tb_barang.kodeBarang = tb_kwitansi.kodeBarang WHERE tb_kwitansi.noBukti="'.$dt['noBukti'].'"')->result_array();
                                        foreach ($barang as $barang){?>
                                      ...
                                      <?php $l=$this->db->query('select tb_pegawai.namaPegawai as nm from tb_pegawai join tb_user on tb_pegawai.NIP_pegawai = tb_user.NIP_pegawai WHERE tb_user.username="'.$dt['username'].'"')->result_array(); foreach($l as $w){?>
                                      <td><?php echo $w['nm'];?></td>
                                      <?php } ?>
                                      <?php $total = $this->db->query('select SUM(hargaTotal) as total from tb_kwitansi where noBukti="'.$dt['noBukti'].'"')->result_array();
                                      foreach($total as $tot) {?>
                                      <td><?php echo 'Rp. ' . number_format( $tot['total'], 0 , '' , '.' ) . ',-';?></td>
                                      <?php } ?>
                                      <td>
                                          <center>
                                            <div class="tooltip-demo">
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="ubah-data<?php echo $y; ?>" class="modal fade">
    <div class="modal-dialog" style="width: 50%">
      <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url('Kwitansi/ubahDistribusi')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="modal-body">
                ...
                <?php $brg=$this->db->query('select tb_barang.namaBarang, tb_barang.kodeBarang, tb_kwitansi.jumlah, tb_kwitansi.idDistribusi from tb_barang INNER JOIN tb_kwitansi ON tb_barang.kodeBarang = tb_kwitansi.kodeBarang WHERE tb_kwitansi.noBukti="'.$dt['noBukti'].'"')->result_array(); $w=1;
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input name="namaUser" id="namaUser" value="<?php echo $dt['username'];?>" required placeholder="Pemberi" class="form-control" type="text">
                    <input name="NIP_user" id="NIP_user" value="<?php echo $dt['username'];?>" required placeholder="Pemberi" class="form-control" type="hidden">
                  </div>
                </div>
            </div>
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="kwitansi<?php echo $z; ?>" class="modal fade">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <form class="form-horizontal" action="<?php echo base_url('Kwitansi/cetakKwitansi')?>" method="post" enctype="multipart/form-data" role="form" target="_blank">
                <div class="modal-body">
                    <div class="form-group">
                      <label class="control-label col-md-3">No Bukti</label>
                      <div class="col-md-9">
                        <?php $brang=$this->db->query('select idDistribusi from tb_kwitansi WHERE tb_kwitansi.noBukti="'.$dt['noBukti'].'"')->result_array();
                        foreach ($brang as $d) { ?>
                    ...
                    <div id="form-group2">
                    <?php $brg=$this->db->query('select tb_barang.namaBarang, tb_barang.kodeBarang, tb_kwitansi.jumlah from tb_barang INNER JOIN tb_kwitansi ON tb_barang.kodeBarang = tb_kwitansi.kodeBarang WHERE tb_kwitansi.noBukti="'.$dt['noBukti'].'"')->result_array(); $w=1;
                    foreach ($brg as $d) { if ($w==1) { ?>
                      <div class="form-group">
                        <label class="control-label col-md-3">Detail Barang</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3">Penerima</label>
                      <div class="col-md-9">
                        <input name="NIP_pegawai" readonly id="NIP_pegawai" value="<?php echo $dt['namaPegawai'];?>" required placeholder="Satuan" class="form-control" type="text">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3">Pemberi</label>
                      <div class="col-md-9">
                        <?php $l=$this->db->query('select tb_pegawai.namaPegawai as nm from tb_pegawai join tb_user on tb_pegawai.NIP_pegawai = tb_user.NIP_pegawai WHERE tb_user.username="'.$dt['username'].'"')->result_array(); foreach($l as $w){?>
                        <input name="NIP_user" id="NIP_user" readonly value="<?php echo $w['nm'];?>" required placeholder="Pemberi" class="form-control" type="text">
                        <?php } ?>
                      </div>
                    </div>
                </div>
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="hapus-data<?php echo $y; ?>" class="modal fade">
    <div class="modal-dialog" style="width:30%;margin-top: 150px;">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('Kwitansi/hapusDistribusi/'.$dt['noBukti']);?>" method="post" enctype="multipart/form-data" role="form">
        <div class="modal-body">
      ...
      <div class="modal-dialog" style="width:40%;margin-top: 100px;margin-left: 400px">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="form" value="Kwitansi/formDistribusi">
            <div class="form-group">
        ...
        $('#bukti2').change(function(){
          ...
          if(kab=='-')
          {
          ...
          }else
           {
              ...
              $.ajax({
                url:"<?php echo base_url('Kwitansi/combo')?>",
                type:"POST",
                data:{'kab':kab},
                datatypec:'json',
      ...
      function showBarang(str) 
      {
          ...
          if (str == "") {
            ...
            xmlhttp.open("GET", "<?= base_url(
              'index.php/kwitansi/getbarang') ?>/"+str,true);
            xmlhttp.send();
          }
      }
      ...
      var table;
        $(document).ready(function() {
          ...
          table = $('#table_transaksi').DataTable({ 
            ...
            "ajax": {
                "url": "<?= site_url('kwitansi/ajax_list_transaksi')?>",
                "type": "POST"
            },
        ...
        function addbarang()
        {
           ...
           // ajax adding data to database
              $.ajax({
                url : "<?= site_url('kwitansi/addbarang')?>",
                type: "POST",
              ...
              $('#bukti1').prop('readonly',true);
              $('#bukti2').prop('readonly',true);
              $('#bukti3').prop('readonly',true);
              $('#bukti4').prop('readonly',true);
        ...
        function deletebarang(id,sub_total)
        {
            // ajax delete data to database
              $.ajax({
                url : "<?= site_url('kwitansi/deletebarang')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
